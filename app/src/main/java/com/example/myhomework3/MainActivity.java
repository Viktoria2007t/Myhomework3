...
import com.example.myhomework3.model.RailwayTicket;
import  com.example.myhomework3.model.RailwayTicketChild;
import com.example.myhomework3.model.RailwayTicketPensionery;
public class MainActivity extends AppCompatActivity {
    ...
    RailwayTicket railwayTicketPensionery = new RailwayTicketPensionery(70, 5, 30);
    ...
    private TextView railwayTicketPensioneryOut; // поле вывода общей стоимости всех билетов
    ...
    protected void onCreate(Bundle savedInstanceState) { // создание жизненного цикла активности
        ...
        railwayTicketPensioneryOut = findViewById(R.id.railwayTicketChildOut3); // вывод информации стоимости всех пенсионерских билетов
        ...
        // 3) заполнение третьего поля воспользовавшись переопределённым методом подсчёта стоимости пенсионерских билетов ticketPriceAll()
        railwayTicketPensioneryOut.setText(Float.toString(railwayTicketPensionery.ticketPriceAll()) + " монет");
        // 4) заполнение четвертого поля стоимостью всех билетов
        railwayTicketTotalOut.setText(Float.toString(railwayTicket.ticketPriceAll() + railwayTicketChild.ticketPriceAll()+railwayTicketPensionery.ticketPriceAll()) + " монет");
